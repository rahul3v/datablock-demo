...
export default function ChangeLogger({ limit = 8 }: ChangeLoggerProps) {
  ...
  return (
    <div className="react-flow__devtools-changelogger rounded translate-y-[4rem] max-height-200px">
